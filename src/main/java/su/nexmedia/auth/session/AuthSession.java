...
public class AuthSession {
    ...
    public AuthSession(@NotNull String inetAddress) {
    ...
    public boolean mustBeDestroyed() {
        if (!AuthUtils.isPublicAddress(this.getAddress())) return true;
    ...
    public void ban(long seconds) {
        if (!AuthUtils.isPublicAddress(this.getAddress())) return;
